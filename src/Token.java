public class Token {
    ...
    public static final Token readIntTok = new Token(TokenType.GetInt, "getInt");
    public static final Token readFloatTok = new Token(TokenType.GetFloat, "getFloat");
    public static final Token printTok = new Token(TokenType.Put, "put");
